...
### set up ###
Script_scores <- read.table("C:\\Users\\SVerhavert\\Desktop\\DV1 analysis\\taak1\\ ranking_estimates_A1_rand.txt", 
                            header=T, sep="\t", dec=".")
...
Data <- read.table("C:\\Users\\SVerhavert\\Desktop\\DV1 analysis\\DV1.csv",
...
# selected representation (5), left representation (7), right representation(9)
Data <-Data[,c(5,7,9)]
...
source("C:/Users/SVerhavert/Desktop/Simulation/iterativeML.R")
